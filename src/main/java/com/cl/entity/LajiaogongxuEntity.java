...
public class LajiaogongxuEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public LajiaogongxuEntity() {
		
	}
	
	public LajiaogongxuEntity(T t) {
		try {
	...
	private String shijishengchanzhangdu;
	 ...
	 * 设置：实际生产长度
	 */
	public void setShijishengchanzhangdu(String shijishengchanzhangdu) {
		this.shijishengchanzhangdu = shijishengchanzhangdu;
	}
	/**
	 * 获取：实际生产长度
	 */
	public String getShijishengchanzhangdu() {
		return shijishengchanzhangdu;
	}
	/**
	 * 设置：所用材料统计
	 */
