 ...
 */
@TableName("hutaogongxu")
public class HutaogongxuEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public HutaogongxuEntity() {
		
	}
	
	public HutaogongxuEntity(T t) {
		try {
	...
	private String bengongxuwanchengchengdu;
	 ...
	 * 设置：本工序完成程度
	 */
	public void setBengongxuwanchengchengdu(String bengongxuwanchengchengdu) {
		this.bengongxuwanchengchengdu = bengongxuwanchengchengdu;
	}
	/**
	 * 获取：本工序完成程度
	 */
	public String getBengongxuwanchengchengdu() {
		return bengongxuwanchengchengdu;
	}
	/**
	 * 设置：所用材料统计
	 */
